...
# Выбранная мишень
# CHEMBL ID для DYRK1A человека: CHEMBL2292
# PDB ID для структуры с лигандом: 4YU2
# 4YU2 юазовый
# 3ANQ: Структура в комплексе с ингибитором
# 3ANR: Структура в комплексе с гармином
# 5AIK: Структура в комплексе с ингибитором LDN-211898
# 4AZE: Структура в комплексе с ингибитором Leucettine L41
...
PRETRAINED_HF_CONFIG = {
    ...
    "chembl_sample_size": 2000,  # Размер выборки из ChEMBL
    "pad_token_id": 0,
    "bos_token_id": 0,
    "eos_token_id": 0,
    "pad_token": "<pad>",
...
HIT_SELECTION_FILTERS = {
    ...
    "selectivity_filters": {
        ...
        "target_kinases": ["DYRK1B", "DYRK2", "GSK3B", "CDK5", "CK1"],
    },
}
...
PIPELINE_PARAMETERS = {
    ...
    "model_training": {"cross_validation_folds": 5, "test_size": TEST_SIZE, "random_state": RANDOM_STATE, "stratify": True},
    "molecule_generation": {
    ...
    "hit_selection": {"max_hits": 100, "diversity_threshold": 0.7, "cluster_method": "butina", "cluster_threshold": 0.6},
    "docking": {
